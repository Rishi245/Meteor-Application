...
export default class MeteorScreen extends Component {
    ...
    getMeteors = ()=>{
        ...
        axios.get(
            'https://api.nasa.gov/neo/rest/v1/feed?start_date=2021-08-09&end_date=2021-08-16&api_key=JHL5bgBePcp4Pgeqx9t3t5C682NA4WFDKPixejtF',   
        ).then(response=>{
